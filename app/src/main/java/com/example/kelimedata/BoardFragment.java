...
public class BoardFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        modelListLeft.add(new Model("une", "bir", 1));
        modelListLeft.add(new Model("deux", "iki", 2));
        modelListLeft.add(new Model("troi", "üç", 3));
        modelListLeft.add(new Model("quatr", "dört", 4));
        modelListLeft.add(new Model("cinq", "beş", 5));
        modelListLeft.add(new Model("six", "altı", 6));
        modelListLeft.add(new Model("sept", "yedi", 7));
        modelListLeft.add(new Model("huit", "sekiz", 8));
        modelListLeft.add(new Model("neuf", "dokuz", 9));
        modelListLeft.add(new Model("dix", "on", 10));
